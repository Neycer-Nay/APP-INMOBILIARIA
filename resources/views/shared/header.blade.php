...
<header class="bg-[#e09129] bg-opacity-5 text-white shadow-lg">
  <div class="container mx-auto flex items-center h-24 justify-between md:justify-center space-x-0 md:space-x-32 px-4">
    ...
    <button id="mobile-menu-button" class="md:hidden flex items-center px-3 py-2 border rounded text-white border-white focus:outline-none">
...
>
  ...
  <nav id="mobile-menu" class="md:hidden hidden bg-[#e09129] bg-opacity-95 text-[#404656] px-4 pt-2 pb-4">
    <ul class="flex flex-col gap-y-2 font-semibold text-base menu-font">
      ...
      <li>
        <details>
          <summary class="py-2 px-2 cursor-pointer nav-text">SERVICIOS</summary>
          <ul class="pl-4">
            <li><a href="#" class="block py-1 px-2 hover:bg-gray-100">Trámites legales</a></li>
            <li><a href="#" class="block py-1 px-2 hover:bg-gray-100">Avalúos</a></li>
            <li><a href="#" class="block py-1 px-2 hover:bg-gray-100">Préstamos hipotecarios</a></li>
          </ul>
        </details>
      </li>
      <li>
      ...
      <li>
        <a href="https://wa.me/59175026366" target="_blank"
          class="border border-white rounded-full font-bold px-4 py-2 flex items-center space-x-2 hover:bg-green-500 transition-colors mt-2">
          <img src="https://cdn-icons-png.flaticon.com/512/733/733585.png" alt="WhatsApp" class="w-5 h-5" />
