    ...
    <div class=" min-h-screen py-8 ">
        <div class="relative w-full h-[600px] flex items-center justify-center"
            ...
            <div class="relative z-10 text-center text-[#404656]">
                <h1 class="text-3xl md:text-6xl text-[#e09129] font-bold titulo-poppins mb-6 leading-tight">Encuentra El
                    Hogar
                    De Tus Sueños
                </h1>
                ...
                @foreach($casasRecientes as $casa)
                    <div class="bg-[#ffffff] rounded-lg shadow p-3">
                        ...
                        <a href="{{ route('casas.show', $casa->id) }}">
                            ...
                            @else
                                <div class="w-full h-48 bg-gray-200 rounded-lg mb-3 flex items-center justify-center text-gray-400">
                                    Sin
                                    imagen</div>
                            @endif
                        </a>
        ...
        <div class=" min-h-screen py-8 ">
            ...
            <span class="block text-base text-gray-500 text-center mb-8">
                Descubre nuestros inmuebles en traspaso: con solo una cuota inicial te entregamos el inmueble y el saldo
                pagas
                al banco.</span>
            <div class="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 ">
        ...
        <!-- Esta seccion afecta a la altura de mi header en la vista inicio -->
