            ...
            <div class="flex flex-col md:flex-row gap-8">
                ...
                <div class="md:w-1/2 space-y-8">
                    ...
                    <section>
                        ...
                        <p class="text-[#404656] font-bold">En Casa y Chalet somos la empresa más completa del mercado
                ...
                <div class="md:w-1/2 flex flex-col gap-6">
                    <div class="bg-[#e09129] bg-opacity-10 rounded-lg p-6">
                        ...
                        <p class="text-[#000] font-bold">Brindar soluciones inmobiliarias integrales, honestas y
                    ...
                    <div class="bg-[#e09129] bg-opacity-10 rounded-lg p-6">
                        ...
                        <p class="text-[#000] font-bold">Ser la inmobiliaria líder en la región, reconocida por la
