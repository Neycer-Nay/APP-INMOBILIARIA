...
<body class="bg-[#fffaf3] text-gray-800" style="font-family: 'Muli', sans-serif;">
    ...
    <div class="md:ml-64 min-h-screen flex flex-col transition-all duration-300">
        ...
        <!-- Top Header -->
        <header
            class="bg-white shadow-sm border-b border-gray-200 h-16 flex items-center justify-between px-4 md:px-8 sticky top-0 z-30">
            <div class="flex items-center gap-4">
                <button id="sidebar-toggle"
                    class="md:hidden p-2 rounded-lg text-[#404656] hover:bg-[#e09129]/20 transition-colors focus:outline-none">
            ...
            <div class="flex items-center gap-4">
                ...
                <a href="{{ route('inicio') }}" target="_blank"
                    class="p-2 rounded-lg text-[#404656] hover:bg-[#e09129]/20 transition-colors" title="Ver sitio web">
